                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="text" placeholder="Mobile"></input>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input class="form-control" type="password" placeholder="Current Password"></input>
                                </div>
                                <div class="col-md-6">
                                    <input class="form-control" type="text" placeholder="New Password"></input>
                                </div>
                                <div class="col-md-6">
                                    <input class="form-control" type="text" placeholder="Confirm Password"></input>
                                </div>
                                <div class="col-md-12">
