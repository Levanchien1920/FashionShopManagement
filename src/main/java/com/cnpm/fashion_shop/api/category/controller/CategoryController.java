...
//    public ResponseEntity<Response> updateCategory(@PathVariable("category_id") Long id,
...
//    public ResponseEntity<Response> deleteCategory(@PathVariable("category_id") Long id) {
...
//    public ResponseEntity getOneBrand(@PathVariable("category_id") Long id) {
