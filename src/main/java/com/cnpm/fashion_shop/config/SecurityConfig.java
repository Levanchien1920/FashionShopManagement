...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/api/v1/admin/user/**", "/api/v1/saleFigureByMonth/**", "/api/v1/saleFigureEmployee/**","/api/v1/invoice/**","/api/v1/role/**","/api/v1/admin/product/**")
                ...
                .antMatchers( "/api/v1/customer/**","/api/v1/client/user/**", "/api/v1/client/invoice/**")
