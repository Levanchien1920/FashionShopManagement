...
const HomeComponent = () => {
  ...
  useEffect(() => {
    ...
    setLoadingNew(true);
    axiosInstance
      .get(`/client/product/new?page=${offsetNew}`)
      .then((response) => {
        setLoadingNew(false);
  ...
  useEffect(() => {
    ...
    setLoadingRev(true);
    axiosInstance
      .get(`/client/review/good?page=${offsetRev}`)
      .then((response) => {
  ...
  const renderFooterNew = () => {
    return (
      <View style={styles.footer}>
        ...
        <View>
          {totalPageNew === 1 ? null : totalPageNew - 1 > offsetNew ? (
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => {
                setOffsetNew(offsetNew + 1);
  ...
  const renderFooterRev = () => {
    return (
      <View style={styles.footer}>
        ...
        <View>
          {totalPageRev === 1 ? null : totalPageRev - 1 > offsetRev ? (
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => {
                setOffsetRev(offsetRev + 1);
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flexDirection: "column", margin: 10 }}>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={{ color: "black", fontSize: 14, width: 250 }}>
                  {item.name_Product}
                </Text>
              </View>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={{ color: "black", fontSize: 14, width: 150 }}>
                  {item.content}
                </Text>
              </View>
            </View>
